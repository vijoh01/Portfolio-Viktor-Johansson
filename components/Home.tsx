      ...
      <div className='flex items-center h-[95%] w-full md:justify-center'>
        ...
        exit="hide" variants={introPictureVariants} className='flex flex-col-reverse justify-between w-full pt-[2rem] md:flex-row md:w-[50rem] lg:w-[60rem]'>
          ...
          <div id="target-element" className="min-h-[22.6rem]  max-h-[22.6rem] md:max-h-[22.6rem] lg:max-h-[22.6rem] md:min-h-[25rem] md:w-[28rem] lg:min-h-[31.5rem] lg:w-[34rem] md:translate-x-[22rem] lg:translate-x-[27.5rem] flex justify-center items-center overflow-hidden">
            ...
            <Image  className='-translate-x-28 pointer-events-none filter grayscale dark:grayscale-[0.3] brightness-125 dark:brightness-125 min-w-[24rem] w-[24rem] md:min-w-[28rem] lg:min-w-[35rem] lg:scale-110 md:lg:translate-y-[10rem] translate-y-28' src={viktor} alt='dasd'></Image>
          </div>
        </motion.div>
      </div>
